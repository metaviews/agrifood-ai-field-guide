...
- **G-319** (n=1, src=scans/2026-07-canada-value-chains.md:296) — No CAAIN project is Indigenous-led in the surfaced sources. G-313 carries through: no federal Indigenous-led agrifood AI funder; no CAAIN project lead is Indigenous-led.
- **G-320** (n=1, src=scans/2026-07-canada-value-chains.md:297) — No CAAIN project is in Newfoundland and Labrador, PEI, Yukon, NWT, or Nunavut. CAAIN's geographic coverage is ON, QC, SK, MB, AB, BC, NB, NS — 8 of 13 provinces/territories. CanNor REGI-AI is the separate funding channel for the North.
- **G-321** (n=1, src=scans/2026-07-canada-value-chains.md:298) — Operational scale of CAAIN projects not publicly disclosed for many projects (4AG Robotics, Nectar BeeTrack, Circulus Agtech, A.U.G. Signals, Grain Discovery). Vendor-reported figures are limited; independent verification not surfaced.
- **G-322** (n=1, src=scans/2026-07-canada-regional-substrate.md:268) — AIDA's specific industry partnerships and deployment outcomes not publicly detailed. AIDA is named as the Atlantic substrate but its specific industry-facing projects (vs. academic research) need follow-up.
- **G-323** (n=1, src=scans/2026-07-canada-regional-substrate.md:269) — DFO's three Pacific salmon AI pilots are pilot-stage. Operational scale (number of scales processed, number of fish counted, number of watershed plans supported) not publicly tracked.
- **G-324** (n=1, src=scans/2026-07-canada-regional-substrate.md:270) — PolArctic Sanikiluaq operational status (production mariculture vs. pilot-completed) is unclear. The 2021 pilot completion is documented; whether the AI tool is now in production is not.
- **G-325** (n=1, src=scans/2026-07-canada-regional-substrate.md:271) — OnDeck Fisheries AI's $1.5M PCAIS-funded project is positioned as building infrastructure, not as a deployed operational monitoring system. Deployment state needs tracking.
- **G-326** (n=1, src=scans/2026-07-canada-regional-substrate.md:272) — Mowi Canada West Feed Centre's operational AI deployment scale (number of farm sites, tonnes of fish under management) is industry-framing only. The 2026 DFO transition plan for 79 BC salmon farms is unresolved — operational future uncertain.
- **G-327** (n=1, src=scans/2026-07-canada-regional-substrate.md:273) — Salmon Vision's stated expansion to Koeye and KwaKwa rivers (Yukon) is forward-looking. Operational deployment beyond Bear River and Kitwanga needs verification.
- **G-328** (n=1, src=scans/2026-07-canada-regional-substrate.md:274) — The Canadian Soil Data Portal (soildataportal.ca) is a nationally-scaling infrastructure project led by AIDA's Brandon Heung. Specific provincial coverage and accessibility tiers not publicly documented.

## Canada academic-research substrate (July 2026 cycle)

- **G-329** (n=1, src=units/ai4food-guelph.md; updated by units/uog-bean-gpt-najafabadi.md) — AI4Food's specific industry partnerships, deployed acreage, and named partner farms / companies not publicly detailed. **Partially filled by BeanGPT (see `units/uog-bean-gpt-najafabadi.md`): 9 named partner orgs + 6 named projects in the Najafabadi lab. The broader AI4Food faculty-project inventory remains incomplete.**
- **G-330** (n=1, src=units/aal-dalhousie.md) — AAL's specific AI-technique deployment projects are not surfaced in primary sources; AAL's substantive contribution is the data-deficit critical voice, not AI technique deployment.
- **G-331** (n=1, src=units/mila-quebec-agrifood.md; supersedes G-029 in scans/2026-07-quebec-cycle.md:99) — DISA is Rwandan-deployment + Canadian-research-pipelined, not Canadian-partner-farm deployment. Mila + IVADO agrifood profile is "Canadian ML capacity reaching international food systems" rather than "Canadian agrifood deployment." The original G-029 framing ("Mila DISA partner farms and concrete deployed acreage") should be retired or reframed — DISA's substantive agrifood-AI finding is the *method* (satellite + ML for regenerative-ag identification at scale), not Canadian acreage.
- **G-332** (n=1, src=units/canada-academic-research-funding-stack.md) — No dedicated federal academic-research funding channel for agrifood AI as a sectoral priority at the research tier; Canadian agrifood AI research is funded as part of general NSERC + Mitacs + CFI + CFREF programs. The cluster tier (CAAIN) has an agrifood-AI-specific channel; the research tier does not.
- **G-333** (n=1, src=scans/2026-07-canada-academic-research-substrate.md:240) — Provincial RDC (Research and Development Centre) academic-research inventory not surfaced for AAFC Sherbrooke RDC, AAFC Lacombe RDC, AAFC Saint-Hyacinthe RDC, etc. AAFC runs multiple RDCs that are relevant academic-tier partners; specific RDC × agrifood-AI projects not enumerated.
- **G-334** (n=1, src=scans/2026-07-canada-academic-research-substrate.md:241) — Amii (Edmonton) + Vector Institute (Toronto) agrifood-AI projects not enumerated. PCAIS Tier 1 institute coverage is asymmetric — only Mila's agrifood surface is visible; Vector and Amii agrifood projects not surfaced.
- **G-335** (n=1, src=units/uog-bean-gpt-najafabadi.md) — BeanGPT + the Najafabadi Dry Bean Breeding & Computational Biology Lab funding stack: NSERC, Ontario Bean Growers, ARIO, OMAFA, Sprague Foods, Hensall Co-Op, Agilent Technology, RIO visible at lab level; Food from Thought (CFREF) / Mitacs / RAII funding-stack specifics (grant numbers, project codes, award years) not publicly documented.
- **G-336** (n=1, src=units/uog-bean-gpt-najafabadi.md) — AgData Consortium named as a partner on the AI4Food Najafabadi faculty page. Specific institutional structure, member list, data-sharing terms, and relationship to U Guelph not publicly documented.
- **G-337** (n=1, src=units/programmatic-breeding-ai.md) — Multinational seed-corporate internal AI pipelines (Bayer Crop Science / Syngenta / BASF / Corteva) are private IP and not publicly documented at the pipeline-architecture level. Substantive observation can be made (programmatic-breeding is the default commercial workflow) but deployment scale is unverifiable in public sources.
- **G-338** (n=1, src=units/plant-breeding-ai-methodology.md) — Breeder subjective vs. AI-augmented speed breeding: comparative cycle-time empirical validation across academic / public / corporate breeding programs not at a single comparable level.
- **G-339** (n=1, src=units/plant-breeding-ai-methodology.md) — Public-domain breeding-data availability for academic AI research (CGIAR-EiB making progress; commercial pipelines are private) — substantive open-data gap.
- **G-340** (n=1, src=units/longping-yuan-caas-china-seed-ai.md) — Deployment scope (acreage under Syngenta Group China Seeds; lines evaluated per cycle by CAAS) is not visible in public primary sources at the same level as Bayer's pipeline disclosures.
- **G-341** (n=1, src=units/longping-yuan-caas-china-seed-ai.md) — Chen Hu 等 (CAAS livestock / digital agriculture) and broader Chinese academic AI-crop research inventory — only partial inventory surfaced.
- **G-342** (n=1, src=units/cgiar-eib-global-south-plant-breeding.md) — CGIAR-Breeding-for-Tomorrow 15-30% genetic-gain commitment — by-2030 operational verification needed.
- **G-343** (n=1, src=units/cgiar-eib-global-south-plant-breeding.md) — Substantive AI-IP-ownership question for AI-augmented CGIAR-bred varieties (when CGIAR germplasm is augmented with AI, who owns the AI-augmented output).
- **G-344** (n=1, src=units/cgiar-eib-global-south-plant-breeding.md) — CGIAR Trust Fund Window 1/2/3 funding transparency (substantive criticism since 2017).
- **G-345** (n=1, src=units/limagrain-kws-ragt-eu-private-plant-breeding.md) — EU private-breeding corporate R&D spending on AI is not visible at the same granularity as multinational-corporate pipelines.
- **G-346** (n=1, src=units/limagrain-kws-ragt-eu-private-plant-breeding.md) — NGT-2 GMO retention substantively constrains AI-augmented breeding for substantial-modification outputs; substantive NGT-1 vs. NGT-2 operational distinction worth tracking.
- **G-347** (n=1, src=units/bayer-syngenta-corteva-multinational-pipelines.md) — Syngenta Group IPO post-2026 will substantiate Syngenta Group's substantive financial position; substantive corporate-finance observation to track.
- **G-348** (n=1, src=units/bayer-syngenta-corteva-multinational-pipelines.md) — Corporate R&D pipeline AI-deployment scope per crop / per region is not consistently disclosed; Bayer Crop Science is the substantive most-disclosed; others less so.
- **G-349** (n=1, src=units/usda-ars-iowa-state-aiira-us-land-grant.md) — USDA-NIFA AFRI FY2026 $140M pool + AI Research Institutes funding specifics by project / year not aggregated.
- **G-350** (n=1, src=units/usda-ars-iowa-state-aiira-us-land-grant.md) — Heritable Agriculture substantive deployment scale (deployment scope, partnership depth with BASF/Corteva/etc.) not fully disclosed.
- **G-351** (n=1, src=units/usda-ars-iowa-state-aiira-us-land-grant.md) — Biographica partnership depth with BASF not fully documented.
- **G-352** (n=1, src=units/indigenous-seed-sovereignty-ai-breeding.md) — Substantive 2024-2026 DSI multilateral-mechanism negotiation outcome not yet determined; substantive 2026-2030 deployment will determine AI plant-breeding governance frame.
- **G-353** (n=1, src=units/indigenous-seed-sovereignty-ai-breeding.md) — Substantive Indigenous-led AI plant-breeding deployment beyond PolArctic Sanikiluaq not surfaced; substantive deployment gap.
- **G-354** (n=1, src=units/ai-breeding-genetic-diversity-counter-narrative.md) — Substantive empirical validation of speed-vs-diversity tension at the 12-priority-crop + 4-firms-56% scale not yet available; substantive 2026-2030 deployment will determine substantive tension.
- **G-355** (n=1, src=units/ai-breeding-genetic-diversity-counter-narrative.md) — Substantive farmer-led + Indigenous-led seed-network governance integration into AI plant-breeding pipelines substantively sparse; substantive deployment gap.

## Open-source AI substrate scan (July 2026 cycle, G-356..365)

Surface scan for `scans/2026-07-open-source-ai-substrate-v2.md`. Note: original scan used G-OSAI-NN prefix; reformatted to G-NNN registry numbering to fit corpus convention. The src reference is the substrate scan itself.

- **G-356** (n=1, src=scans/2026-07-open-source-ai-substrate-v2.md §8.1 — was G-OSAI-01) — Aggregate quantitative impact of open-source AI in agrifood. Mozilla's 3% / 79% / 51% / 4% / 89% figures are AI-ecosystem-wide; the agrifood-specific equivalents (adoption rate, capability gap on agrifood tasks, deployment rate, revenue capture by agrifood AI vendors) are not surveyed in published form as of Jul 2026. Mozilla + Pennells et al. 2025 + IFPRI + Wu 2025 are neighbouring work; an agrifood-specific quantitative panel does not exist. **Closed substantively by anchor unit `units/open-source-ai-agrifood-quantitative-panel.md` (July 2026) with six aggregation currents (bibliometric / adoption-rate / market-size-aggregator / public-investment / open-source-share / multilateral-deployment); G-366..G-371 carry the cells the literature does not yet fill.**
- **G-357** (n=1, src=scans/2026-07-open-source-ai-substrate-v2.md §8.1 — was G-OSAI-02) — Apply OSAID 1.0 to agrifood models. None of the field guide's tracked agrifood open-source AI deployments (FarmVibes.AI, FarmOS, GAIA, AgML, CGIAR tools) have been scored against OSAID 1.0's four-element requirement (weights + build code + dataset code + data or data information). OSI's binary-threshold framing makes this a yes/no scoring pass.
- **G-358** (n=1, src=scans/2026-07-open-source-ai-substrate-v2.md §8.1 — was G-OSAI-03) — Whether EUROPA consortium explicitly covers agrifood-language modelling. 24 EU languages covered; multilingual agrifood extension not yet confirmed in primary sources.
- **G-359** (n=1, src=scans/2026-07-open-source-ai-substrate-v2.md §8.1 — was G-OSAI-04) — Whether AgStack (Linux Foundation project) has an AI track. Linux Foundation's agricultural stack-project. Whether AAIF / AgStack intersect not yet found.
- **G-360** (n=1, src=scans/2026-07-open-source-ai-substrate-v2.md §8.1 — was G-OSAI-05) — Whether Mistral / Cohere / Qwen foundation models have substantive agricultural fine-tunes in production. Anecdotal fine-tunes exist (Mistral fine-tuned for French agronomy per Pillaud; Qwen fine-tunes for Chinese agronomy); production-grade case studies not yet surfaced.
- **G-361** (n=1, src=scans/2026-07-open-source-ai-substrate-v2.md §8.1 — was G-OSAI-06) — Whether the EU "Buy European" proposed framework extends to AI infrastructure procurement for agrifood. EuroStack white paper covers strategic digital procurement broadly; agrifood-specific clauses not yet found.
- **G-362** (n=1, src=scans/2026-07-open-source-ai-substrate-v2.md §8.1 — was G-OSAI-07) — Whether China / HK IPO 2026 (Zhipu, MiniMax) double-listed agrifood deployments. Mozilla report flags both as substantive open-weights actors; agrifood fine-tunes not yet surfaced.
- **G-363** (n=1, src=scans/2026-07-open-source-ai-substrate-v2.md §8.1 — was G-OSAI-08) — Whether the FAO's Digital Public Goods certification includes any open-weights agrifood models. eLocust3 and FarmStack are DP Goods (per Vincent Martin Sep 2024); open-weights LLM with agrifood DPG certification not yet found.
- **G-364** (n=1, src=scans/2026-07-open-source-ai-substrate-v2.md §8.1 — was G-OSAI-09) — Whether AAIF-equivalent for agrifood exists. Linux Foundation hosts AAIF; no equivalent for agrifood-LM harness or agrifood-specific agent standards surfaced.
- **G-365** (n=1, src=scans/2026-07-open-source-ai-substrate-v2.md §8.1 — was G-OSAI-10) — Whether the agentic harness gap has agrifood-specific writing-up. Mozilla's "portable permission" framing is generic; agrifood-specific permission models (JoinData-style, OCAP-style) have not been paper-anchored.

## Open-source AI substrate scan — contested claims (C-313..319)

Surface scan for `scans/2026-07-open-source-ai-substrate-v2.md`. Note: original scan used C-OSAI-NN prefix; reformatted to C-NNN registry numbering to fit corpus convention.

- **C-313** (n=1, src=scans/2026-07-open-source-ai-substrate-v2.md §8.2 — was C-OSAI-01) — "Open-source AI is technically competitive with proprietary AI on frontier tasks." *Asserting:* Mozilla 2026, Stanford HAI 2026 AI Index, DeepSeek R1 model card, Qwen team publications. *Contesting:* Closed reasoning models pulling ahead (3.3% gap reopened Mar 2026); Gemini 3 89% multi-needle retrieval at 1M tokens vs DeepSeek V4-Pro's 41%; labs now invest in integrated harness + model pairs (Codex CLI 83.4% vs Claude Code 83.1% on Terminal-Bench 2.1). *Position:* Capable at workloads that matter most for production deployment; trailing at workloads that constitute the new contest. *Last-reviewed:* Jul 2026.
- **C-314** (n=1, src=scans/2026-07-open-source-ai-substrate-v2.md §8.2 — was C-OSAI-02) — "Open-source AI is essentially free / cheaper than proprietary AI in production." *Asserting:* Mozilla 2026 (50× cost collapse); Linux Foundation Nagle-Yue study (~$24.8B unrealised savings, ~6× per-call differential); Stripe 73% inference cost cut on vLLM. *Contesting:* 89% of AI-enabled firms use open components (Tony Blair Institute); but 67% of generative AI pilots fail (MIT NANDA). *Position:* Cheaper at the per-token layer; not necessarily cheaper in total cost of ownership without mature deployment infrastructure. *Last-reviewed:* Jul 2026.
- **C-315** (n=1, src=scans/2026-07-open-source-ai-substrate-v2.md §8.2 — was C-OSAI-03) — "Open-source AI is more secure than proprietary AI." *Asserting:* Mozilla 2026; NTIA "monitor, not restrict"; CVSS 9.3–9.4 failures hit closed systems (Anthropic, Microsoft, ServiceNow, Salesforce). *Contesting:* Open weights + CoSAI MCP threat model flags consent fatigue; safety fine-tuning can be stripped from open weights; embedding-only filters less effective when weights self-hosted; CNAS response identifies dual-use risks. *Position:* Security is a function of the harness layer, not the openness of the model. Closed is not the same as secure; open is not the same as insecure. *Last-reviewed:* Jul 2026.
- **C-316** (n=1, src=scans/2026-07-open-source-ai-substrate-v2.md §8.2 — was C-OSAI-04) — "Public investment in open-source AI provides national competitive advantage." *Asserting:* EuroStack industry letter (~500 signatories); EUROPA competition framework; China State Council "AI Plus" Initiative; India IndiaAI Mission; Canada "AI for All". *Contesting:* Mozilla's framing that "the open default consolidates into a single source at all" — a commons with one supplier isn't a commons. *Position:* Public money holds through the slow middle, but only if plural sourcing is structurally required. *Last-reviewed:* Jul 2026.
- **C-317** (n=1, src=scans/2026-07-open-source-ai-substrate-v2.md §8.2 — was C-OSAI-05) — "Open-source AI in agrifood is a deliberate cultural choice in continuity with traditional seed saving." *Asserting:* A Growing Culture "Open Source Ethos" Jan 25, 2023; field guide's prior synthesis on this bridge. *Contesting:* The Mozilla framing is purely economic-strategic; OSI's framing is purely legal-software; FAO's framing is purely development-equity. None of them cite agricultural cooperative / commons heritage. The bridge is constructive but constructed — not present in the source primaries. *Position:* The cultural bridge is productive for the field guide's framing but should be flagged as a constructive interpretation, not as documented cross-source consensus. *Last-reviewed:* Jul 2026.
- **C-318** (n=1, src=scans/2026-07-open-source-ai-substrate-v2.md §8.2 — was C-OSAI-06) — "Open-source AI will replace proprietary AI in agrifood." *Asserting:* Mozilla 2026 finding that open weights win the tokens; DeepSeek 58% of new AI startups in 2025; ~80% open-source model usage vs ~96% open-source revenue captured by closed providers on Linux Foundation study. *Contesting:* Mozilla 2026 itself — the 4% revenue capture implies open-source remains a complementary layer. Closed harness development (Terminal-Bench 2.1) consolidating vertical integration. *Position:* Open-source *models* increasingly competitive on capability; open-source *products* not yet coherent at frontier. Likely complementary for the foreseeable future. *Last-reviewed:* Jul 2026.
- **C-319** (n=1, src=scans/2026-07-open-source-ai-substrate-v2.md §8.2 — was C-OSAI-07) — "Granite, DeepSeek R1, OLMo are 'true' open-source AI under OSAID 1.0." *Asserting:* OSI Sept 2025 blog — "Increasing openness: Models like Granite and DeepSeek R1 are progressively releasing more training code and infrastructure; AI2 OLMo fully open." *Contesting:* Even the most open of these has caveats — DeepSeek R1 lacks full RLHF code (also see Sanity-check §13 item 9 about Mistral licensing variants); OLMo lacks scale; Granite lacks compute-equivalent weights. None trivially passes the OSAID test. *Position:* OSI's "binary threshold" framing means edge cases are informative but mostly fail the test. *Last-reviewed:* Jul 2026.

## Agrifood AI quantitative panel scan (July 2026 cycle, G-366..371)

Surface scan for `scans/2026-07-open-source-ai-agrifood-quantitative-panel.md`. The panel closes G-356 substantively where the literature exists (Pennells 2025, EPRS 2023, Stanford AI Index 2025, GAO/McFadden 2024, IFPRI 2025–26) and surfaces six specific missing rows that together would constitute a comprehensive panel.

- **G-366** (n=1, src=scans/2026-07-open-source-ai-agrifood-quantitative-panel.md §11.1) — agrifood-AI capability gap × open weights vs proprietary. Mozilla 2026 has 3.3% capability gap for AI ecosystem; the agrifood-specific equivalent (capability gap on agrifood tasks like weed-id, plant disease, yield prediction, food-safety imaging) is not surveyed. *Sources searched:* Pennells 2025, EPRS 2023, Stanford AI Index 2025, Mozilla 2026, Omotayo 2025, IFPRI 2025–26. *Last-searched:* Jul 2026.
- **G-367** (n=1, src=scans/2026-07-open-source-ai-agrifood-quantitative-panel.md §11.1) — agrifood-AI adoption rate by sector position × farm size. McFadden 2024 gives US precision-ag overall (27%) and stratified by farm size; no equivalent for *AI specifically* or for sector positions like processing / distribution / retail / consumption. *Sources searched:* McFadden 2024 (USDA ER), GAO-24-105962, EPRS 2023, Pennells 2025. *Last-searched:* Jul 2026.
- **G-368** (n=1, src=scans/2026-07-open-source-ai-agrifood-quantitative-panel.md §11.1) — agrifood-AI revenue capture by vendor tier (open vs proprietary). Mozilla 2026 has 4% revenue capture for open AI; the agrifood-specific vendor-tier breakdown (OpenAI / Anthropic / Cohere / Mistral agrifood revenue vs agrifood vendor revenue from open-source like Microsoft FarmVibes + OMB) is not surveyed. *Sources searched:* Mozilla 2026, market aggregators (Mordor/BCC/FMI/GMI), EU EPRS 2023. *Last-searched:* Jul 2026.
- **G-369** (n=1, src=scans/2026-07-open-source-ai-agrifood-quantitative-panel.md §11.1) — Published agrifood-AI deployment-scale metrics by farm size × region. McFadden 2024 gives US precision-ag; the cross-country panel (US / China / Brazil / EU / Africa / India / Canada farm-level adoption rates broken out by farm-size quintile) does not exist as a single published survey. *Sources searched:* McFadden 2024, CGIAR reports (not separately pulled), FAO digital-agriculture surveys. *Last-searched:* Jul 2026.
- **G-370** (n=1, src=scans/2026-07-open-source-ai-agrifood-quantitative-panel.md §11.1) — Public-investment in open-source AI in agrifood specifically. Stanford AI Index 2025 gives Canada $2.4B / China $47.5B semis / France €109B / India $1.25B / Saudi $100B as aggregate national AI investments; the *agrifood carveout* is not available at the same granularity for any of these. *Sources searched:* Stanford AI Index 2025, Mozilla 2026 (referenced national strategies), IndiaAI, China State Council AI Plus, Canada "AI for All", EuroStack, AAFC. *Last-searched:* Jul 2026.
- **G-371** (n=1, src=scans/2026-07-open-source-ai-agrifood-quantitative-panel.md §11.1) — IFPRI Jones-Garcia framework for responsible GAI in agricultural extension — quantitative assessment. Jones-Garcia 2026 paper presents the C-H-A-T framework and argues for participatory design; a quantitative panel (number of agricultural extension programmes using GAI by region × by 2027) is not yet specified. *Sources searched:* IFPRI GAIA project page, IFPRI publications. *Last-searched:* Jul 2026.

## Agrifood AI quantitative panel scan — contested claims (C-320..325)

Surface scan for `scans/2026-07-open-source-ai-agrifood-quantitative-panel.md`.

- **C-320** (n=1, src=scans/2026-07-open-source-ai-agrifood-quantitative-panel.md §12 — was C-OSAI-08 of the new scan series) — "The agrifood sector is slow to adopt AI." *Asserting:* Pennells 2025 introduction (food industry "lags behind sectors like finance and healthcare due to the complexity of food systems, including high process variability, risk aversion towards novel technologies, and constrained investment appetite"). *Contesting:* Pennells 2025 same source ("the perception that the food sector has been slow to adopt AI is not entirely true. The industry has long integrated data-driven modelling and computational techniques... while not always explicitly labelled as AI"). EPRS 2023 ("there is growing interest in the applications of AI in the agri-food sector"). 27% US precision-ag (GAO 2024) is not "slow" by most sectors' standards. *Position:* The disagreement is about *how to define AI*, not about *whether adoption is occurring*. *Last-reviewed:* Jul 2026.
- **C-321** (n=1, src=scans/2026-07-open-source-ai-agrifood-quantitative-panel.md §12) — "Market-research aggregators' forecasts for agrifood AI ($77B by 2036; 26% CAGR) are substantive economic evidence." *Asserting:* Multiple aggregators (Mordor, BCC, FMI, Grand View, GMI). *Contesting:* Mozilla 2026 — open-source AI captures 4% of revenue; vendor-aggregator framing consistently overstates deployment scale. *Position:* Aggregator forecasts are *vendor-and-consultant-sourced* and methodologies don't agree on basics. 2× spread on 2024–25 baselines; 9× spread on 2030–36 forecasts; treat as scan-level finding, not unit-level adoption claim. *Last-reviewed:* Jul 2026.
- **C-322** (n=1, src=scans/2026-07-open-source-ai-agrifood-quantitative-panel.md §12) — "China leads food-AI publication output, but the US leads AI investment overall." *Asserting:* Pennells 2025 (China 35 / India 18 / US 5 in food-AI review corpus); Stanford AI Index 2025 (US $109.1B AI investment 12× China $9.3B). *Contesting:* Mozilla 2026 — 95% East Asia adoption including China at 89%; Stanford AI Index 2025: China 83% AI optimism (highest of any country) vs US 39%. *Position:* Publication and investment decoupled. Chinese food-AI publication lead may reflect state-funded research programmes; US investment leadership reflects hyperscaler capital that doesn't translate proportionally into food-AI publications. *Last-reviewed:* Jul 2026.
- **C-323** (n=1, src=scans/2026-07-open-source-ai-agrifood-quantitative-panel.md §12) — "Stanford AI Index 2025 AI-firm adoption (78% of orgs) implies comparable agrifood adoption." *Asserting:* Stanford "Business is all in on AI" framing. *Contesting:* Federal Reserve / Allen 2026 — adoption is sector-stratified; lowest-AI-adoption sectors include agriculture. McFadden 2024 — 27% US farm-level precision-ag (broader than AI). Stanford 78% is *orgs in general*, weighted toward information services and tech-forward sectors, not agrifood. *Position:* Stanford's 78% cannot be propagated to agrifood. The two figures measure different things at different levels; conflating them is a structural risk. *Last-reviewed:* Jul 2026.
- **C-324** (n=1, src=scans/2026-07-open-source-ai-agrifood-quantitative-panel.md §12) — "AI can be a 'game-changing' tool for smallholder farmers (FAO 2024 framing)." *Asserting:* FAO Director Qu Dongyu + Vincent Martin — "AI can be a game-changing solution for farmers" (FAO 2024 framing per newsroom entry). *Contesting:* Mozilla 2026 51% deployment gap; Omotayo 2025 — "inadequate technological infrastructure, limited data accessibility, skill deficits"; EPRS 2023 — broadband access, training, and digital literacy remain structural blockers. *Position:* AI's *potential* for smallholder farmers is established; AI's *delivery* to smallholder farmers requires infrastructure not yet deployed at scale. The optimism-vs-deployment gap matches Mozilla 51%/79%. *Last-reviewed:* Jul 2026.
- **C-325** (n=1, src=scans/2026-07-open-source-ai-agrifood-quantitative-panel.md §12) — "Open-source AI will democratise agrifood AI by reducing cost-as-a-barrier." *Asserting:* Mozilla 2026 — 50× cost collapse; A Growing Culture "Open Source Ethos" continuity; Mozilla "Be owners, not renters." *Contesting:* Pennells 2025 — China publishes 35 food-AI reviews but China adoption in agricultural deployment tracks large farms not smallholders; EPRS 2023 — broadband access is a binding constraint (not model cost); Mozilla 2026 itself — the deployment gap is *infrastructure*, not capability. *Position:* Open-source *lowers per-token cost*; it does *not solve the infrastructure-and-access gap*. *Last-reviewed:* Jul 2026.

## AI and Labour scan (July 2026 cycle, G-372..384)

Surface scan for `scans/2026-07-ai-and-labour.md` and `scouts/2026-07-ai-and-labour-scout.md`. The scan reads labour-side material across the corpus's six strata (on-farm robotics / specialty-crop / food-processing / consumer-AI / critical-voice / labour-policy) and surfaces substantive absences that the cycle units + quotes + methodological commitments address but do not close.

- **G-372** (n=1, src=scans/2026-07-ai-and-labour.md §3.1 — new) — labour-monitoring / surveillance dual-use of agrifood computer vision systems. Cargill CarVe explicitly names the dual-use (cameras that estimate yield can also monitor worker pace, technique, breaks). Tyson × AWS / Smithfield vision / Wendy's FreshAI / Sweetgreen Infinite Kitchen deployments have the same dual-use structure but their units do not name it. Partially addressed by `units/labour-displacement-na-meat-processing.md` for the meat-processing layer; consumer-AI + specialty-crop layers not surfaced. *Last-searched:* Jul 2026.
- **G-373** (n=1, src=scans/2026-07-ai-and-labour.md §3.2 — new) — labour-displacement quantification in NA meat processing. Cargill + Tyson + Smithfield + JBS + Maple Leaf + SoraLINK deployments have deployment-scale numbers (the corpus has them); workforce-impact numbers (pre/post employment; worker count + role-shift) are structurally thin across the cell. UFCW collective bargaining + Smithfield historical worker-safety context named but quantified labour-impact not surfaced. *Last-searched:* Jul 2026.
- **G-374** (n=1, src=scans/2026-07-ai-and-labour.md §7 — new; partial surface: Sullivan unit) — H-2A + AI deployment data at regional level. What does H-2A scale (US DOL FY2024: 384,362 visas) + automation deployment look like in a region? Salinas Valley is the worked example via Sullivan ethnography + California overtime regulation; Florida berries / Washington apples / Central Valley table grapes / Georgia Vidalia are not surfaced. Partially addressed by `units/us-specialty-crop-farmworker-context.md`. *Last-searched:* Jul 2026.
- **G-375** (n=1, src=scans/2026-07-ai-and-labour.md §7 — new) — SAWP + AI deployment data. Canadian SAWP programme (~60,000+ workers annually; Caribbean + Mexico bilateral); AI deployment + SAWP interaction not surfaced in corpus. *Last-searched:* Jul 2026.
- **G-376** (n=1, src=scans/2026-07-ai-and-labour.md §7 — new) — LAC seasonal labour + AI deployment. Brazilian + Chilean + Argentine + Mexican seasonal labour programmes + AI deployment interaction not surfaced. *Last-searched:* Jul 2026.
- **G-377** (n=1, src=scans/2026-07-ai-and-labour.md §7 — new) — SSA smallholder labour + AI deployment. Mozilla State of Open Source AI 2026 + CGIAR + AgriLLM + AGRA + smallholder labour context; not surfaced as labour-displacement framing in corpus. *Last-searched:* Jul 2026.
- **G-378** (n=1, src=scans/2026-07-ai-and-labour.md §6.3 — new) — Korean state-cluster labour-substitution outcome data. 30%-by-2027 adoption target has labour-side outcome dimension (rural labour force, farm size, generational succession) not yet unitised. Partially addressed by `units/korean-state-cluster-labour-substitution.md`. *Last-searched:* Jul 2026.
- **G-379** (n=1, src=scans/2026-07-ai-and-labour.md §6.3 — new) — EU AI Act labour-side implementation track. Title III high-risk AI systems; employment context as one of eight high-risk categories. AI Act enforcement body (European AI Office + national authorities like AESIA Spain + CNIL France) labour-side implementation is structurally distinct from data-governance track and is not surfaced in corpus. *Last-searched:* Jul 2026.
- **G-380** (n=1, src=scans/2026-07-ai-and-labour.md §6.3 — new) — Packers and Stockyards Act (USDA 1921) + AI deployment. The P&S Act is the labour-relations regulatory substrate of US meat-packing; AI deployment at scale without P&S Act engagement is a structural gap. *Last-searched:* Jul 2026.
- **G-381** (n=1, src=scans/2026-07-ai-and-labour.md §4.3 — new) — UFCW / UFCW Canada / NFU / CLC formal position on AI deployment. Collective bargaining agreements + Senate submissions + organising campaigns; substantive institutional voice not surfaced as primary source in corpus. Partially addressed by `units/ufcw-nfu-clc-canada-labour-producers.md` for institutional names; specific AI-deployment policy positions require primary-source verification. *Last-searched:* Jul 2026.
- **G-382** (n=1, src=scans/2026-07-ai-and-labour.md §4.3 — new) — back-of-house worker displacement quantification in working consumer-AI deployments. Wendy's FreshAI / Taco Bell × Omilia / Sweetgreen Infinite Kitchen have deployment scale; back-of-house worker count + role-shift data not surfaced. Wendy's 86%-completion-without-human-intervention is the most-specific public metric. *Last-searched:* Jul 2026.
- **G-383** (n=1, src=scans/2026-07-ai-and-labour.md §4.3 — new) — voice AI 2026-vintage viability. Whisper-class accuracy improvements since the 2024 discontinued cluster (McDonald's × IBM ended June 2024); whether voice AI for noisy drive-thru is now viable at commercial scale. Worth tracking because the discontinued cluster's labour-displacement-doesn't-happen-yet pattern may shift as voice models mature. *Last-searched:* Jul 2026.
- **G-384** (n=1, src=scans/2026-07-ai-and-labour.md §4.3 — new) — front-of-house worker voice on consumer-AI deployment. Restaurant workers + AI deployment; not surfaced as primary source in corpus. Restaurant Workers Union / SEIU / UNITE HERE formal positions on consumer-AI labour also not surfaced. *Last-searched:* Jul 2026.

## AI and Labour scan — contested claims (C-326..328)

Surface scan for `scans/2026-07-ai-and-labour.md`.

- **C-326** (n=1, src=scans/2026-07-ai-and-labour.md §11 — new) — "AI will replace agricultural labour at scale." *Asserting:* CNH Neilson *"a dwindling labor force"* framing; Lely 50,000 robots / 30 years deployment; advanced-farm-tech strawberry robotics commercial scale since 2019. *Contesting:* Sullivan "zero percent" head lettuce + McDonald's × IBM discontinued June 2024 + Kroger Ocado closures November 2025 ("bet on robotics went too far") + Sweetgreen Spyce sold September 2025 — the discontinued cluster as labour-displacement-doesn't-happen-yet pattern. Wendy's 86%-completion-without-human-intervention is the most-specific public labour-automation-rate metric on a working voice-AI deployment. *Position:* The empirical record is mixed and structurally nuanced; the claim as stated is too general. Where automation is widely deployed (Lely dairy robotics, Deere See & Spray row crops, Wendy's voice AI), labour displacement is real but bounded. Where automation is announced but not deployed at scale (specialty-crop harvest; consumer-AI voice-ordering; grocer fulfilment-centre robotics), labour displacement is constrained by technology limits. The labour-displacement question is *answered differently* depending on which task + which technology + which sector. *Last-reviewed:* Jul 2026.
- **C-327** (n=1, src=scans/2026-07-ai-and-labour.md §11 — new) — "Automation saves labour cost at commercial scale." *Asserting:* Cargill CarVe *"a one percent yield improvement can save hundreds of millions of pounds of meat"*; Smithfield automation investment *"several hundred million $"*; Maple Leaf Braincube +12% yield / 3-month ROI. *Contesting:* The labour-cost framing depends on whether automation replaces workers, augments workers, or just changes how workers are managed. Cargill CarVe + Tyson × AWS + Smithfield vision are *primarily* labour-monitoring + yield-improving (process intelligence as privacy surface); secondarily labour-displacing. The labour-displacement dimension is partial, not 1:1. Maple Leaf Braincube is *primarily* digital-twin + plant-optimisation with worker-safety-augmentation dimension. The displacement-vs-augmentation-vs-management distinction is not unitised across the corpus. *Position:* Automation *saves labour cost* is too general; the labour-cost framing depends on which dimension (displacement, monitoring, augmentation) is foregrounded. *Last-reviewed:* Jul 2026.
- **C-328** (n=1, src=scans/2026-07-ai-and-labour.md §11 — new) — "AI addresses agricultural labour shortage." *Asserting:* CNH Neilson *"a dwindling labor force. Autonomy will become an integral part of farmers' operations everywhere"*; Lely Torrie *"If we didn't invest in new technology, there wasn't going to be succession"* (succession-as-driver-of-automation); Korean 30%-by-2027 smart-farming adoption target (state-led quantitative labour-substitution target). *Contesting:* Sullivan ethnography — harvest automation not at commercial scale ("zero percent" head lettuce); farmworker focus group *"people are always going to be needed"*; roboticist *"You need hands to cut lettuce... It's a really hard nut to crack"*. The discontinued cluster pattern (McDonald's + Kroger + DoorDash) — where automation wasn't ready, labour displacement didn't happen. Fairbairn + Kish + Guthman *Pitching Agri-Food Tech* — non-disruptive-disruption framing; investor pitch overstates deployment scale. *Position:* The labour-shortage framing is real and structural; the *automation solves it* claim is contested by the harvest-not-at-commercial-scale finding + the discontinued cluster pattern + the non-disruptive-disruption framing. Automation *complements* farmworker labour (solves solvable tasks like weeding; leaves unsolvable tasks like harvest to farmworkers) rather than *replacing* it. *Last-reviewed:* Jul 2026.

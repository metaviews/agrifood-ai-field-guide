...
This is the corpus's lead registry - actor-networks, foundational
actors, and substantive future-unit candidates surfaced during cycle work.

Leads differ from gaps. A **gap** is an absence: data not found, deployment
not verified. A **lead** is a direction: an actor / cluster / framework
surfaced during research that warrants its own future write-up.
...
- **ushahidi-civic-tech-agrifood-ai.md** — realized from `2026-07-africa-open-source-agrifood.md` L574
  gaps: G-270
  Ushahidi unit covering Kenyan origin 2007 + civic tech open-source + potential agritech AI deployment.
- **open-data-kit-africa-agritech.md** — realized from `2026-07-africa-open-source-agrifood.md` L575
  gaps: G-271
  ODK unit covering Nigeria + Sierra Leone + Tanzania + Ghana + multi-country African deployment.
- **open-source-seed-initiative-africa.md** — realized from `2026-07-africa-open-source-agrifood.md` L576
  gaps: G-272
  OSSI unit covering 2012 + Daniel Wanjama + African seed-sovereignty.
- **godan-2-0-africa-open-data.md** — realized from `2026-07-africa-open-source-agrifood.md` L577
  gaps: G-273
  GODAN 2.0 unit covering Africa chapter + 2024 side event outcomes.
- **code-for-africa-ai-for-good.md** — realized from `2026-07-africa-open-source-agrifood.md` L578
  gaps: G-274
  Code for Africa AI For Good Fellowship 2026 unit.
- **mozilla-common-voice-african-languages.md** — realized from `2026-07-africa-open-source-agrifood.md` L579
  gaps: G-275
  Common Voice 23.0 + Maseno University + Africa Next Voices + Kiswahili Hackathon.
- **alliance-bioversity-ciat-banana-disease-dashboard.md** — realized from `2026-07-africa-open-source-agrifood.md` L580
  gaps: G-276
  Alliance Bioversity-CIAT 100,000+ GPS-referenced banana disease observations across 17 countries.
...
- **agra-alliance-green-revolution-africa.md** — realized from `2026-07-sub-saharan-africa-multilateral.md` L578
  gaps: G-244, G-245
  AGRA unit covering 15 million smallholder farmers, $1.3 billion mobilized, 13 countries, Mastercard Foundation partnership.

## Open leads (named target unit not yet written)

These leads are explicitly named in scan 'Future units surfaced'
...
- **ai-gates-foundation-digital-green-viamo.md** — surfaced in `2026-07-sub-saharan-africa-multilateral.md` L580
  gaps: G-246
  AIEP unit covering Gates Foundation + Digital Green + Viamo + GIZ practitioner/co-design pattern.
- **tapas-climate-adaptation-irri-genebank.md** — surfaced in `2026-07-sub-saharan-africa-multilateral.md` L581
  gaps: G-249, G-251
  TAPAS + IRRI genebank unit covering climate-adaptation AI in agriculture.
...
These are cluster-level or framework-level leads that aren't tied to
...
that the corpus has already agreed need units. After the cycle completes,
moves from 'Open leads' to 'Realized leads' (or extend the 'Realized'
list). 'Cluster-pattern candidates' are the speculative layer - they're
useful for prospective cycles where you want to surface structural
patterns rather than fill data holes.

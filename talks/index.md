...
- [`canada-ids-cycle-2026-07.md`](canada-ids-cycle-2026-07.md) — 6 new units + 1 unit update + 2 new quotes + 1 quote date correction. Substantive finding: framework-deployment funding-instrument gap (G-313) — Canadian Indigenous-led agrifood AI deployments are operational (PolArctic, Salmon Vision, NEDA, Inuvik Tech, Indigenous Pathfinders) but funded through non-Indigenous-specific federal instruments; the framework side (CARE, IEEE 2890-2025, OCAP, FNDGS, IQ) is rich; the dedicated funder does not exist. Major upgrade for archetype 05. **Cycle completed July 2026.**

**Cycle history** (older cycle annotations archived to `talks/cycle-history-archive.md` for compactness):
- Canada Indigenous Data Sovereignty cycle (July 2026) — 6 new units (1 consolidated + 5 dedicated) + 1 unit update (existing `units/indigenous-data-sovereignty.md`) + 2 new quotes + 1 quote date correction. Substantive findings include: framework-deployment funding-instrument gap, PolArctic Two-Eyed Seeing operational pattern, Salmon Vision BC Indigenous-led wild salmon AI, FNDGS as operative Canadian framework, NCIAF as institutional vehicle, Mila Indigenous AI infrastructure (correction: not a CSA joint-committee standard), Ruder-Wittman as substantive Canadian analytical voice, IEEE 2890-2025 explicitly for AI/ML industries. See `canada-ids-cycle-2026-07.md`.

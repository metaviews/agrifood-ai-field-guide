...
| Field | Value |
|---|---|
| **Spine** | cooperative-alternative |
| **Audience** | policy, cooperative-organisation leadership, academic (especially agricultural-economics / political-economy / STS audiences) |
| **Duration** | 60 min (45 min talk + 15 min Q&A) |
| **Depth** | specialist (full taxonomy fluency; the audience knows cooperative theory or is willing to learn) |
| **Region emphasis** | EU-Netherlands (JoinData) + EU-France (La Ferme Digitale, GAIA) + US (NAPDC), with comparative reference to Indigenous-led frameworks |
| **Stance** | curious, critical, collaborative — with explicit framing that cooperative / commons infrastructure is *real, deployed, and replicable in specific cultural conditions* |
...
- 260 parties sharing data via JoinData
- 70 parties using data for the farmer
- €50/year farmer membership fee
- Companies pay fees for "data transport" — JoinData reinvests
...
- Djessie Donkers (ZLTO): the vendor-fragmentation problem JoinData solves. `quotes/producers/donkers-djessie-joindata-vendor-fragmentation.md`.
...
- Not a data repository (sharing platform; doesn't store farmer data)
...
- Not a substitute for Ag Data Transparent (control vs contract transparency)
...
| **Mondragón Cooperative Federation (Spain)** — `units/mondragon-corporation-cooperative-federation.md` | Cooperative-federation-led (Basque Country) | Federation of worker cooperatives since 1956; €11.213B 2024 revenue | **Cooperative-federation institutional substrate** | Operational since 1956; multi-sector (industrial / consumer-goods / agricultural / financial / retail); 70,000+ workers |
| **Spanish Cooperative AI cluster (Spain)** — `units/spain-cooperative-agrifood-ai-cluster-pattern.md` | Peer-reviewed-led + Mondragón-anchor + emerging-single-coop | IUDESCOOP + UPV CEGEA + HEC Paris academic-tier; Mondragón federation-tier; COVAP Reto Innovación Abierta 2025 deployment-tier | **Cluster-with-three-structures** | Five named AI deployment tracks at COVAP; corpus's first Spanish cooperative-led AI deployment-of-record |
...
**Quantitative-panel context (added cycle).** Per `units/open-source-ai-agrifood-quantitative-panel.md` (Public-Investment / Capacity-Build current), the cooperative / commons / state-stewarded substrate is funded at materially different levels across regions: Stanford AI Index 2025 reports Canada $2.4B / China $47.5B / France €109B / India $1.25B / Saudi $100B in national AI investments (agrifood carveout not separately available — G-370). The WAGRI / AgriStack / *AI for All* (RAII $200M → $500M trajectory per June 2026) / EuroStack / ItalyAI / CGIAR ($200M UAE-Gates-CGIAR partnership) / AGRA (Rockefeller + Gates + Mastercard Foundations) / Mozilla (Mozilla Foundation grantmaking) all sit on the *funding-side* layer that supports — or doesn't support — the cooperative / commons / state-stewarded data-substrate choices. **The structural observation worth surfacing to the audience:** *the data-substrate leg of the cooperative / commons / state-stewarded choice does not stand alone* — it is conditioned by the public-investment layer that the panel names. Per panel rows G-370 (public-investment in open-source AI in agrifood specifically), the agrifood carveout of Stanford's national AI investments is not yet published; per panel-row G-368 (agrifood-AI revenue capture by vendor tier), the proportion of public-investment that flows to cooperative / commons / state-stewarded substrates vs proprietary vendor capture is not surveyed.
...
- *"What about blockchain-based agricultural data platforms?"* → Worth knowing: several blockchain / distributed-ledger proposals exist (e.g. JD Farm in China uses blockchain traceability). They are *not* the same as cooperative / commons infrastructure. Blockchain is a technical layer; cooperative is a governance layer. The two can combine but are not interchangeable.
- *"What about the developing world?"* → Cooperative / commons infrastructure in SSA, South Asia is thin. The replication question is genuine. Indigenous data sovereignty frameworks (`units/indigenous-data-sovereignty.md`) are a parallel and partially-overlapping framework — worth naming for any audience concerned with global food sovereignty.
- *"What about Mondragón / Spanish cooperatives?"* → `scans/2026-07-spanish-cooperatives-ai.md` for the cluster scan; three anchor units (`units/mondragon-corporation-cooperative-federation.md` — federation of worker cooperatives since 1956, €11.213B 2024 revenue, 70,000+ workers; `units/spain-cooperative-agrifood-ai-cluster-pattern.md` — Spanish cooperative AI cluster-with-three-structures observation; `units/spain-cooperative-covap-ai-deployment.md` — corpus's first Spanish cooperative-led AI deployment-of-record with 5 named AI tracks). Worth surfacing: *Mondragón is federation-substrate; JoinData is data-rights-substrate; both are cooperative-statutory frameworks but structurally distinct (multi-sector federation vs. single-sector data-rights).*
- *"What about Canadian cooperatives in agrifood AI?"* → The Canadian corpus carries a *founder-pattern observation* rather than a JoinData equivalent. Per `talks/canada-deepening-cycle-2026-07.md` §13 archetype-04 upgrade notes: the CAAIN founder-pattern (immigrant / multi-generation ag family × technical training × federal funding as the leveller — Weiping Zeng on MacDon Industries' $9.26M total: "served as a lifeline for us at a time when our future was uncertain") is the *closest Canadian analog to Mondragón's institutional-federation-anchor*. CATTLEytics equipment-agnostic milk-ingestion sensor (`units/canadian-dairy-ai.md`) is the producer-led-alternative deployment of record; `units/caain-portfolio-canada.md` is the federal-third-party-delivery alternative to venture capital. Worth surfacing: Canadian cooperative AI is *structurally thin* compared to Mondragón's federation (no equivalent federation substrate), but the founder-pattern + federal-third-party-delivery combo is the *Canadian-specific cooperative-statutory analog*. The gap (G-corpus-thin) is precisely the absence of a deployed JoinData equivalent or a Mondragón-anchor cooperative federation in Canada.
- *"Is Mozilla / open-source AI sufficient?"* → Mozilla State of Open Source AI 2026 shows open-source is becoming default in some categories. But open-source models running on proprietary data infrastructure is a real pattern; cooperative / commons is a *stricter* requirement than open-source alone.

## Freshness check

- JoinData figures: Feb 2023. Verify on annual cadence. Likely higher in 2026.
- La Ferme Digitale / GAIA: April 2025 INRAE report. Verify on annual cadence.
- NAPDC: development phase. Verify deployment status annually.
- OADA: open-source project. Verify activity annually (GitHub commits, mailing list activity).
- Mozilla State of Open Source AI 2026: July 2026. Confirm next-year report cadence.

## Substitutions

- **If audience is farmer co-op**, swap segments 2-4 for the Canadian context (haven-greens, fcc-root-ai, the gap that there is no Canadian JoinData equivalent). Roughly archetype 02 with more depth.
- **If audience is policy / leadership**, shorten segments 4-6 and lead with the funding-model critique. Roughly archetype 03 with the cooperative spine.
- **If audience is academic STS / political-economy**, deepen segment 5 with contested claims and the parallel-but-distinct Indigenous data sovereignty framework.

...
- *"What about the quantitative scale of all this?"* → `units/open-source-ai-agrifood-quantitative-panel.md`. The corpus's empirical anchor for any "what's actually deployed at scale" claim. The panel's six aggregation currents cover bibliometric (Pennells 2025: 213 peer-reviewed AI-food reviews 2004-2024; 35 China + 18 India + 6 Iran + 5 USA + 5 UK + 5 Spain top-six; food-security only 1 of 213), adoption-rate / survey (Stanford AI Index 2025: 78% AI-firm adoption; Allen/Atlanta Fed 2026: *agriculture among lowest-AI-adoption sectors*; McFadden 2024: 27% US farms precision-agriculture as of 2023, stratified by farm size), market-size aggregator (flagged not-load-bearing: 9× forecast spread), public-investment (Stanford: Canada $2.4B / China $47.5B semis / France €109B / India $1.25B / Saudi $100B; **agrifood carveout not separately available — G-370**), open-source-share (Mozilla 2026: 3.3% gap / 50× cost collapse / 33%-usage-4%-revenue / 89% East Asia / 79%-51%-dev-deployed), and multilateral-deployment (CGIAR + AgriLLM + AGRA + AU Continental AI Strategy). *Six specific panel rows where the literature does not yet carry: G-366..G-371.* Worth surfacing honestly: the *vendor-named deployment figures* that this archetype walks through are real at the named-deployment level, but they are not yet panel-comparable across regions / farm sizes / sector-positions / vendor-tiers.

...
### 5. Segment four — Sub-Saharan Africa and Southeast Asia as the corpus's next regional gaps (4 min)

**Pivot to forward-looking.** The corpus has named patterns across nine regional contexts (NA, EU-continental, China, India, Japan, Korea, LAC, MENA, EU-Mediterranean-Spain). Two remaining gaps that the next cycle work should target:

**Sub-Saharan Africa (added cycle — first time surfaced in archetype).** Two scans are in the corpus but not yet promoted to anchor units: `scans/2026-07-sub-saharan-africa-multilateral.md` (multilateral institutional substrate — CGIAR-EiB partner network, FAO Africa regional digital initiatives, AfDB digital agriculture commitments) and `scans/2026-07-africa-open-source-agrifood.md` (open-source deployment pattern — PlantVillage Nuru, ACRE Africa index insurance, CGIAR open-source breeding toolchains). The Sub-Saharan cluster-pattern candidates worth investigating: *multilateral-institutional + smallholder-open-source* (consistent with the open-source-ai-agrifood quantitative panel from `units/open-source-ai-agrifood-quantitative-panel.md`); *mobile-money-anchored smallholder-data-infrastructure* (Kenya M-Pesa + Twiga Foods, Nigeria Farmerline + Econet-style platforms); *cooperative-extention-led* (Kenya dairy + Rwanda coffee); *state-extension-led* (Ethiopia ATA agricultural clusters). Worth surfacing to the audience: *Sub-Saharan Africa is the corpus's largest named-but-not-yet-anchored regional context at the cluster-pattern level* — the next deepening cycle should target primary-source cluster-pattern evidence.

**Southeast Asia.** Per `agrifood-knowledge-base-curation` SKILL known-regional-gaps section: SEA has named actors (DiMuto Singapore, eFishery Indonesia, Semaai Indonesia, FAO Asia-Pacific digital-ag hub Thailand) but no anchor units yet. The cluster-pattern candidates: *smallholder-vendor*; *cooperative-AI*; *momo-tech-style state-corporate* (Vietnam). Surfacing the SEA pattern as a second forward-looking observation: *the corpus has named patterns for nine regions, but the cluster patterns of SSA and SEA remain forward-looking.*

**Why this matters for the talk.** The 6/9/2 cluster-pattern taxonomy is *a working hypothesis, not a settled typology.* Naming the gaps is part of how the talk earns its keep — it does not pretend the corpus is comprehensive; it names what isn't yet documented.
...
- *"What about Spain / Mediterranean / North Africa?"* → `scans/2026-07-spain-north-africa-pillars.md` for the cluster scan; four anchor units (`units/ekonoke-spanish-indoor-hop-hydroponics-ai.md` Spanish corporate-vendor-deployment; `units/spain-agrifoodtech-2025-ecosystem-eatable-adventures.md` Spanish state-trade-promotion + Eatable Adventures + ENIA + CIIAA + 416 startups / 48% AI adoption; `units/morocco-al-moutmir-ocp-agritech.md` Moroccan state-corporate + state-strategy hybrid (OCP Al Moutmir + Green Generation 2020-2030); `units/tunisia-robocare-precision-agriculture.md` Tunisian startup-emerging-expansion (216 Capital + RoboCare)). *Spain operates as EU-cluster-pattern-with-state-trade-promotion-and-corporate-vendor-deployment; Ekonoke 95% water-savings is corpus's most extreme water-savings figure to date; Spanish 48% AI-adoption rate is corpus's highest named ecosystem-level AI-adoption metric.* *Morocco operates as state-corporate + state-strategy hybrid (OCP world's-largest-phosphate + Green Generation 2020-2030); corpus's first Maghreb-region agritech deployment at primary-source tier.* *Tunisia operates as startup-ecosystem-emerging-expansion layer with regional-African VC-funding strategy; corpus's first MENA-extension agritech deployment connecting Tunisian domestic + African + Middle Eastern expansion.* Substantive *EU-cluster-pattern layered-mix observation*: EU is layered-mix (cooperative-governance-NL JoinData + state-trade-promotion-Spain Eatable Adventures/ICEX + corporate-vendor-deployment-Ekonoke + corporate-vendor-deployment-other-EU). Substantive *MENA-region five-cluster-pattern observation*: refined from cycle-4's three-sub-pattern to cycle-5's five-cluster-pattern (Israeli + UAE × 2 + Lebanese + Moroccan + Tunisian).
...
- *"What about Sub-Saharan Africa?"* → Two scans are in the corpus: `scans/2026-07-sub-saharan-africa-multilateral.md` and `scans/2026-07-africa-open-source-agrifood.md`. Cluster-pattern candidates worth investigating: multilateral-institutional + smallholder-open-source (PlantVillage Nuru, CGIAR open-source toolchains); mobile-money-anchored smallholder-data-infrastructure (M-Pesa + Twiga Foods Kenya); cooperative-extension-led (Kenya dairy, Rwanda coffee); state-extension-led (Ethiopia ATA agricultural clusters). Sub-Saharan Africa is the corpus's largest named-but-not-yet-anchored regional context at the cluster-pattern level; the next deepening cycle should target primary-source cluster-pattern evidence. The `units/open-source-ai-agrifood-quantitative-panel.md` and `units/cgiar-eib-global-south-plant-breeding.md` units surface the multilateral-institutional substrate that SSA shares with global-South plant-breeding AI. For audiences interested in the substantive Mozilla / CGIAR / AGRA / Common Voice African-languages *case* (not just the cluster-pattern comparison), see **archetype 07 (open-source + smallholder + multilateral) at `talks/archetypes/07-open-source-smallholder-multilateral.md`** — the dedicated 60-min talk for the SSA + Global South + Mozilla State of Open Source AI 2026 + CGIAR + AgriLLM cycle wave.

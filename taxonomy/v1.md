# Taxonomy — first working draft (v1)

**Status.** First draft (v1), anchored in the initial environmental scan at `scans/2026-07-initial.md`. Superseded by `taxonomy/v2.md` and `taxonomy/revised.md` (v3); retained as change-history anchor.

**Files in this directory:**
- `taxonomy/v1.md` — this file. Change-history anchor.
- `taxonomy/v2.md` — second iteration.

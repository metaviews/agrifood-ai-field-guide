---
id: fcc-canada-ai-adoption
title: Canadian agricultural AI adoption — 1.8% vs 12.2% across other industries
sector-position: (cross-cutting)
ai-technique-class: (cross-cutting)
purpose: (cross-cutting)
claim-type: statistic
activity-status: (not applicable — adoption measurement, not deployment)
...
- gaps: G-007 (Canadian inputs — partly addressed by FCC Capital investment tracking), G-013 (Caribbean)
- contested-claims: C-007 (Canada can become a global leader), C-011 (AI closes smallholder productivity gap), C-008 (existing AI governance covers ag AI)
- related-units: canadian-retail-ai-pattern.md, loblaw-pcxpress-chatgpt.md (Loblaw Canadian consumer-facing AI), jd-farm-iot-blockchain.md (Canadian-context relevant)
- sovereignty-flags: implicit — Canadian AI adoption low in agrifood; data governance unclear (per FCC analysis)
...
- sources:
  ...
  - Statistics Canada. *Business use of AI as of second quarter of 2025*. https://www150.statcan.gc.ca/n1/pub/11-621-m/11-621-m2025008-eng.htm
  - FCC (2026). *AI in Canadian Agriculture: Present Challenges and Future Prospects*. July 14, 2026 (full report).
  - FCC (2026). *FCC Thought Leadership exploring AI opportunities for Canadian agriculture and food*. May 27, 2026.
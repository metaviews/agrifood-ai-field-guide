---
id: agaid-wsu-institute
title: AgAID — USDA-NIFA Institute for Agricultural AI for Transforming Workforce and Decision Support
sector-position: on-farm production — open field (broadacre crops, fruits, vegetables); animal production (limited)
ai-technique-class: predictive ML; computer vision; robotics and autonomy — ground; decision-support systems
purpose: yield optimisation; input reduction (water); climate adaptation; worker conditions; extension and advisory
claim-type: example
activity-status: deployed (research and pilot deployment)
...
- **AIIRA** (`units/aiira-iowa-state-institute.md`) — focuses on row crops and digital twin plant breeding
- **AIFARMS** (`units/aifarms-illinois-institute.md`) — focuses on autonomous farming, livestock, foundational AI
- **AI-CLIMATE** (`units/ai-climate-minnesota-institute.md`) — focuses on climate-smart ag/forestry, carbon markets
- **AI-LEAF** (`units/ai-leaf-penn-state-institute.md`) — focuses on land economy, agriculture, forestry integration
- **Apeel RipeTrack** (`units/apeel-ripetrack.md`) — post-harvest vendor deployment; different cell (vendor, not academic; post-harvest, not on-farm production)
- **John Deere See & Spray** (`units/john-deere-see-and-spray.md`) — row-crop vendor deployment; different cell (vendor, not academic)
...
- gaps: G-017 (US row-crop autonomous machinery beyond Deere — partially addressed by AgAID specialty-crop robotics), G-018 (US specialty crop AI at scale — partially addressed), G-046 (academic-to-deployment translation gap — directly relevant), G-049 (Cooperative Extension AI tool maturity — adjacent)
- contested-claims: C-036 (NSF/USDA-NIFA AI Institutes deliver deployment outcomes — AgAID is research with translation arms; deployment scale structurally modest)
- related-units: aiira-iowa-state-institute.md, aifarms-illinois-institute.md, ai-climate-minnesota-institute.md, ai-leaf-penn-state-institute.md, usda-fy25-26-ai-strategy.md, extension-foundation-2026-national-ai-report.md, john-deere-see-and-spray.md, apeel-ripetrack.md
- sovereignty-flags: implicit — US academic data is research-data; deployed extensions vary by partner
...
- sources:
  ...
  - AgAID Institute. *USDA-NIFA & NSF Invest in AI Research Institutes*. https://agaid.org/usda-nifa/
  - AgAID Institute. https://agaid.org/
  - USDA-NIFA. *AgAID Project Page (1027037)*. https://training-portal.nifa.usda.gov/web/crisprojectpages/1027037-ai-institute-agricultural-ai-for-transforming-workforce-and-decision-support-agaid.html
  - WSU CSANR. *AgAID Project*. https://csanr.wsu.edu/projects/agaid/
  - WSU News. *WSU to lead national AI research institute for agriculture*. July 29, 2021. https://news.wsu.edu/press-release/2021/07/29/washington-state-university-lead-national-ai-research-institute-agriculture/
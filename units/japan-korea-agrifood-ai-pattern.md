...
activity-status: deployed (the pattern is observable across the seven anchor units)
critical-voice: food-sovereignty (state-stewarded data layers in both countries; Japan WAGRI + Korea Smart Farm Innovation Valley + Korea Act on Fostering Smart Farming as primary critical-voice anchors)
capital-intensity: mixed (industrial equipment vendors + state-funded clusters + recurring capital for L4 tractor / vertical-farm scale-out)
language-literacy-profile: mixed (Japanese industrial-automation vendor surfaces; Korean state-supported cluster surfaces; vendor-led Korean AI Daedongi chatbot)
policy-instrument: regulatory, fiscal, strategy (Japan's Aircraft Manufacturing Industry Act revision 2014 + Act on Promotion of Smart Agriculture Utilization 2024; Korea's Act on Fostering Smart Farming + 30%-by-2027 target + zonal designations)
region: East-Asia (Japan and Korea; pair pattern; cross-regional observation contrasting with China, India, NA, EU)
actor: (composite — Spread Co. + Yamaha Motor + Kubota + Yanmar + WAGRI + ioCrops + Daedong AI Lab + RDA + MAFRA + NARO + MAFF)
...
- **The China cluster pattern has now extended to multilateral-state coordination — WAICO, July 2026.** Per `units/waico-alliance-china-multilateral-ai.md`, the China cluster pattern (state-vendor hybrid + provincial autonomy) now extends beyond national-level state-vendor hybrid to *multilateral-state coordination*: WAICO is the corpus's first clean empirical evidence that China's state-vendor hybrid posture is reaching *beyond provincial autonomy* to *multilateral governance*. This refines the China-pattern description: it is now *state-vendor hybrid with provincial autonomy + multilateral-state coordination reach*. Worth surfacing in any talk about how countries shape their agrifood AI clusters — China's posture is no longer domestic + export (XAG, DJI); it is now domestic + export + multilateral institutional design (WAICO). Japan's state-DPI substrate (WAGRI) and Korea's state-anchored cluster (Smart Farm Innovation Valley) are *not* represented in WAICO's 29 founders; their posture toward AI governance is OECD-anchored, not China-anchored.
- **WAICO's design choice — sovereignty-and-development over rights-and-safety — is structurally distinct from IDSov.** Per Carnegie Endowment analysis. WAICO's *sovereignty-and-development-led* design posture is a different design choice from the IDSov lens (per `units/indigenous-data-sovereignty.md`); the two frameworks are not interchangeable.
- **Yamaha FAZER's acres/coverage figure is V0 vendor-reported.** G-075. The L4-grade product-line-maturity is real; the modern fleet figures are not independently audited.
- **The 30%-by-2027 progress metric is V0.** MAFRA self-reported. Encoded in `units/korea-act-fostering-smart-farming.md` and `units/korea-smart-farm-innovation-valley-rda.md`.
...
**The seven anchor units the pattern integrates:**

- `units/spread-techno-farm-vertical-lettuce-japan.md`
- `units/wagri-japan-agricultural-data-platform.md`
- `units/yamaha-fazer-agricopter-drone-japan.md`
- `units/korea-smart-farm-innovation-valley-rda.md`
- `units/iocrops-greenhouse-ai-korea.md`
- `units/daedong-ai-lab-korean-agriculture.md`
- `units/korea-act-fostering-smart-farming.md`

**Sibling meta-pattern units:**

- `units/india-agrifood-ai-pattern.md` — the prior meta-pattern cycle's structural observation
- `units/north-america-consumption-ai-pattern.md` — NA retail-Consumption-cycle meta-pattern (different scope: layer-specific, not country-pair)

**Cross-corpus comparison anchors:**

- `scans/2026-07-china-deepening.md` — China-side cluster context (different pattern: state-vendor hybrid with provincial autonomy, now extending to multilateral-state coordination reach per WAICO below)
- `units/waico-alliance-china-multilateral-ai.md` — China cluster pattern's multilateral extension (WAICO 29 founders, Shanghai HQ, July 2026). Refines the China-pattern description from "state-vendor hybrid + provincial autonomy" to "state-vendor hybrid + provincial autonomy + multilateral-state coordination reach". Japan's WAGRI and Korea's Smart Farm Innovation Valley are *not* WAICO founders; their AI governance posture is OECD-anchored.
- `scans/2026-07-regional.md` and `scans/2026-07-regional-industry-na-eu.md` — earlier regional surveys
- `units/joindata-netherlands.md` — NL cooperative-governed DPI substrate (different posture)
- `units/india-digital-agriculture-mission-agristack.md` — India-side state DPI substrate (different posture; India is notably absent from WAICO despite being a BRICS founder)
- `units/dji-agriculture-global-export.md` — China-side drone vendor neighbour
- `units/xag-china-drone-leader.md` — China primary drone vendor
- `units/alibaba-et-agricultural-brain.md` — China-side AI-first vendor

**Gaps (G-NNN) referenced:**

- G-073 — WAGRI API customer bases
- G-074 — Spread Co. Techno Farm Narita operational date
- G-075 — Yamaha Motor Japan aerial-spraying fleet post-2015 audit
- G-076 — Kubota Type: V commercial deployment
- G-077 — Korean meat-processing / post-harvest line-level AI
- G-078 — NAVER agrifood AI deployment
- G-079 — Korean NACF / NongHyup agrifood-data platform product
- G-080 — Daedong AI Lab H1 2026 L4 tractor release verification

**Contested claims (C-NNN) referenced:**

- **C-054:** "Japanese agrifood AI is aging-farmer-targeted industrial automation; Korean agrifood AI is state-orchestrated young-farmer incubation." This is the pattern claim; this meta-pattern unit's primary structural observation.
- **C-055:** "Yamaha's >35% rice-field coverage in Japan is the highest automated-spray penetration of any national agriculture." Anchored in `units/yamaha-fazer-agricopter-drone-japan.md`; surfaced here as a Japan-side pattern anchor.

## Freshness

- Last verified: 2026-07
- Verification-trigger dates:
  - H1 2026 Daedong L4 tractor release (re-tag `units/daedong-ai-lab-korean-agriculture.md` to S2 with V1 vendor-customer naming if confirmed at release)
  - Q4 2026 / year-end MAFRA interim measurement of 30%-by-2027 target
  - Spread Co. Techno Farm Narita operational status (Narita confirmation closes G-074)
  - WAGRI API customer-base documentation via the operator site (closes G-073)
  - OECD 2026 agricultural policy monitoring (re-cites the Acts)
- Source consolidation: `~/ai-agrifood/recon-japan-korea-agrifood-ai-2026-07-19.md` and `scans/2026-07-japan-korea-cycle.md`.

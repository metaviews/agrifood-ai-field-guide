...
activity-status: deployed (framework articulation); piloting (open-source agrifood AI deployment)
critical-voice: digital-equity
capital-intensity: (cross-cutting — smallholder cooperative to industrial)
language-literacy-profile: (not applicable — multilingual implementations)
...
This unit synthesises how open source weaves through the existing field guide's 49 units, anchored on the **Mozilla State of Open Source AI report (July 14, 2026)** and the **A Growing Culture "Open Source Ethos" framing (January 25, 2023)**.
...
Distinct from:
- **Mozilla State of Open Source AI report unit** (`mozilla-state-of-open-source-ai-2026.md`) — the substantive data anchor; this unit is the agrifood-specific framework synthesis.
- **Open data ecosystem unit** (`open-data-ecosystem.md`) — *agricultural* open data; this unit is *open-source AI in agrifood*.
- **Data cooperatives / commons architecture unit** (`data-commons-architecture.md`) — operational/framework/standards layers of data commons; this unit is broader (software + data + cooperative + Indigenous).

## Why it matters for talks

This unit lets a talk:
1. **Anchor on Mozilla 2026** for substantive figures (3% / 4% / 89% / 51% / 93%).
2. **Bridge to agricultural heritage** through A Growing Culture framing.
3. **Surface the field guide's existing threads** — JoinData, OADA, GAIA, NAPDC, CARE Principles, Indigenous Navigator.
4. **Connect to UN/FAO institutional layer** for international policy engagement.
5. **Name the substantive challenges** — infrastructure gap (Mozilla), sustainability (Pillaud), deployment rate (OpenAgri).
...
- gaps: G-045 (open-source AI deployment in agrifood specifically; gap between Mozilla general finding and agrifood-specific)
- contested-claims: C-035 (new — "Open-source AI is a foreign technical import for agriculture" — counter: A Growing Culture's "open source ethos" frames it as cultural continuation of agricultural heritage)
- related-units: mozilla-state-of-open-source-ai-2026.md, open-data-ecosystem.md, oada-open-ag-data-alliance.md, joindata-netherlands.md, la-ferme-digitale-gaia.md, indigenous-data-sovereignty.md, napdc-national-ag-producer-data-cooperative.md, pillaud-french-agritech-ecosystem.md, data-commons-architecture.md, proprietary-farm-data.md, dark-data-agrifood.md
- sovereignty-flags: explicit — Mozilla's "be owners, not renters"; FAO's "open innovation"; A Growing Culture's "open source ethos"
...
- last-regionally-scanned: 2026-07
- sources:
  - Mozilla (July 14, 2026). *State of Open Source AI*. https://stateofopensource.ai/ and https://blog.mozilla.org/en/mozilla/mozilla-state-of-open-source-ai-report/

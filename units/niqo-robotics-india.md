...
critical-voice: (none directly — vendor framing; soil-health angle substantive)
capital-intensity: smallholder (rental / service-partner model explicitly planned)
language-literacy-profile: low-literacy (minimal training required; daylight / dark operation)
policy-instrument: (none directly; aligned with Sub-Mission on Agricultural Mechanization custom-hiring model)
region: South-Asia (Bengaluru origin; primary deployments Maharashtra + Karnataka, India; USA pilots)
actor: Niqo Robotics (Bengaluru, India; founded 2015 as TartanSense, rebranded March 2023)
actor-type: vendor
...
- gaps: **G-068** (Independent verification of Niqo's deployed-scale figure consistency: 140K cumulative acres per NITI Aayog vs 120K acres / 50 units per Omnivore APAC 2024)
- contested-claims: **C-053** (vendor-reported agrifood AI impact estimates — Niqo's 50–60% pesticide reduction is state-corroborated but vendor-sourced)
- related-units: `cropin-india.md` (private AI-first platform anchor — different model), `itc-maars-india.md` (conglomerate-phygital anchor — different model), `india-agrifood-ai-pattern.md` (meta-pattern unit), `indiaai-mission-agrifood.md` (policy frame — NITI Aayog is the source for the Niqo data), `dji-agriculture-global-export.md` (drone-spray comparator), `john-deere-see-and-spray.md` (autonomous-tractor comparator), `naio-technologies.md` (smallholder weeding-robot comparator — French, EU)

## Freshness

- Sources verified through 2026-07-19.
- NITI Aayog Frontier Tech feature dated 2024-06-19.
- Omnivore APAC AgriFoodTech Investment Report 2024 (tier-5).
- AgFunderNews on TartanSense / Niqo rebrand: 2023-03.
- Global Agriculture on rebrand: 2023-03.
- Last-verified: 2026-07.

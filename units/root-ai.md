...
- gaps: G-003 (consumption × extension-and-advisory), G-013 (Caribbean)
- contested-claims: C-012 (extension LLMs serve producers), C-008 (existing AI governance covers ag AI)
- related-units: fcc-canada-ai-adoption.md (statistic), fcc-ecosystem-not-technology.md (framework), aiva-network.md (FCC ecosystem), canadian-retail-ai-pattern.md (Canadian consumer-facing AI)
- sovereignty-flags: implicit — Crown corporation operates the tool; data flows to FCC infrastructure; user data privacy protections explicit in FCC's design but worth scrutiny
...
- last-regionally-scanned: 2026-07
- sources:
  - FCC. *Root, your virtual farm assistant*. https://www.fcc-fac.ca/en/resources/root-ai
  - Potato News Today (2025). *Smarter fields, faster answers: FCC's virtual assistant Root AI puts farm expertise at producers' fingertips*. July 9, 2025. https://www.potatonewstoday.com/2025/07/09/smarter-fields-faster-answers-fccs-virtual-assistant-root-ai-puts-farm-expertise-at-producers-fingertips/

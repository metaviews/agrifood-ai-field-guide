---
id: fcc-ecosystem-not-technology
title: The ecosystem-not-technology framing — Canadian AI adoption constrained by structure, not tools
sector-position: (cross-cutting)
ai-technique-class: (cross-cutting)
purpose: (cross-cutting)
claim-type: framework
activity-status: (not applicable — analytical framework)
...
- gaps: G-013 (Caribbean), G-007 (Canadian inputs)
- contested-claims: C-007 (Canada global leader), C-008 (existing AI governance covers ag AI), C-011 (AI closes smallholder productivity gap — framework says no, the structural constraints prevent closure)
- related-units: fcc-canada-ai-adoption.md, aiva-network.md, root-ai.md, canadian-retail-ai-pattern.md
- sovereignty-flags: implicit — governance constraint and data sovereignty are connected
...
- sources:
  ...
  - Neethirajan, S. (2026). *Canada's AI strategy stops at city limits*. Policy Options. (Independent confirmation of rural-connectivity constraint.)
---
id: aiira-iowa-state-institute
title: AIIRA — AI Institute for Resilient Agriculture, Iowa State University, $20M, plant digital twins
sector-position: on-farm production — open field (broadacre crops, primarily soybean and corn); inputs (plant breeding)
ai-technique-class: predictive ML; computer vision; generative AI / LLMs (limited)
purpose: yield optimisation; input reduction (fertilizer, water, pesticide); climate adaptation; research and discovery
claim-type: example
activity-status: deployed (research; pilot deployment via breeding pipelines)
...
- **John Deere See & Spray** (`units/john-deere-see-and-spray.md`) — row-crop vendor deployment at scale; different cell (vendor, not academic)
- **Bayer Climate FieldView** (`units/bayer-climate-fieldview.md`) — multi-continent vendor digital farming platform; different cell (vendor)
...
- gaps: G-001 (inputs × all × all — partially addressed by plant breeding work), G-017 (US row-crop autonomous machinery beyond Deere — partially addressed by digital twin breeding), G-046 (academic-to-deployment translation gap — directly relevant)
- contested-claims: C-036 (NSF/USDA-NIFA AI Institutes deliver deployment outcomes — AIIRA delivers through breeding pipelines on multi-year timescale)
- related-units: agaid-wsu-institute.md, aifarms-illinois-institute.md, ai-climate-minnesota-institute.md, ai-leaf-penn-state-institute.md, usda-fy25-26-ai-strategy.md, john-deere-see-and-spray.md, bayer-climate-fieldview.md
- sovereignty-flags: implicit — US research data is partly public; deployed outcomes vendor-mediated via breeding pipelines
...
- last-regionally-scanned: 2026-07
- sources:
  - USDA-NIFA. *AIIRA Project Page (1027030)*. https://training-portal.nifa.usda.gov/web/crisprojectpages/1027030-ai-institute-aiira-ai-institute-for-resilient-agriculture.html
  ...
  - Adve et al. *Advancing AI in Agriculture through Large-Scale Foundation Models*. ACM 2025. https://dl.acm.org/doi/full/10.1145/3760437

---
id: ai-leaf-penn-state-institute
title: AI-LEAF — AI Institute for Land, Economy, Agriculture & Forestry, Penn State lead with Colorado State and others, USDA-NIFA 2023
sector-position: cross-cutting (land economy × agriculture × forestry)
ai-technique-class: predictive ML; computer vision (satellite / remote sensing); decision-support systems
purpose: climate adaptation; supply chain efficiency; governance; extension and advisory
claim-type: example
activity-status: deployed (research; pilot deployment)
...
- **AgAID** (`units/agaid-wsu-institute.md`) — specialty crops and workforce
- **AIIRA** (`units/aiira-iowa-state-institute.md`) — row crops and digital twin plant breeding
- **AIFARMS** (`units/aifarms-illinois-institute.md`) — autonomous farming, livestock
- **AI-CLIMATE** (`units/ai-climate-minnesota-institute.md`) — climate-smart ag/forestry, carbon markets; closely related and collaborator
- **INRAE** (`units/inrae-france-ai-agriculture.md`) — French national research backbone for agricultural AI; institutional comparison: INRAE is single national institute; AI-LEAF is one of many US AI Institutes
...
- gaps: G-012 (climate-adaptation AI specifically for smallholder and pastoralist contexts — adjacent but distinct; AI-LEAF is US industrial frame, not smallholder), G-046 (academic-to-deployment translation gap — directly relevant)
- contested-claims: C-036 (NSF/USDA-NIFA AI Institutes deliver deployment outcomes — AI-LEAF is youngest; deployment outcomes not yet documented)
- related-units: agaid-wsu-institute.md, aiira-iowa-state-institute.md, aifarms-illinois-institute.md, ai-climate-minnesota-institute.md, carolan-colorado-state-critical.md, usda-fy25-26-ai-strategy.md, inrae-france-ai-agriculture.md
- sovereignty-flags: implicit — research data partly public; deployed tools vary by partner
...
- last-regionally-scanned: 2026-07
- sources:
  - NSF AI Institutes. *Institute – AI-LEAF*. https://aiinstitutes.org/institute-ai-leaf/
  - AI-LEAF Institute. https://www.youtube.com/channel/UC0TJXImCC-jKxund0i9Fypw
  - AI-LEAF Institute Facebook. https://www.facebook.com/AILEAFInstitute/
  ...
  - Education.AIInstitutes.org. https://education.aiinstitutes.org/explore

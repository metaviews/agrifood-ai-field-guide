...
3. Configure:
   ...
   - Root directory: `/`
   - Deploy command: `npx wrangler pages deploy dist --project-name=agrifood-ai-field-guide` *(this is what actually pushes the static files to Cloudflare's CDN; required for the domain to serve the built site)*
